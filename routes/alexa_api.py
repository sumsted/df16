...
from routes.alexa_dream_handlers import handle_story_intent, handle_about_intent, handle_gary_intent, handle_dude_intent, \
    handle_help_intent, handle_session_end_request, handle_shipment_intent, handle_order_intent
...
def route_intent(alexa_request, alexa_session):
    ...
    elif intent_name in ["orderIntent"]:
        return handle_order_intent(intent, alexa_session)
